...
<div class="container">
	<h1 class="title text-center">Playlist Board</h1>
	<div class="row">
		<c:forEach items="${list}" var="u">
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
				<div class="card">
					<img class="card-img-top" src="${u.getImg()}" alt="Playlist Image" style="max-height: 200px; object-fit: cover;">
					<div class="card-body">
						<h5 class="card-title">${u.getTitle()}</h5>
						<p class="card-text">
							<strong>ID:</strong> ${u.getSeq()}<br>
							<strong>Genre:</strong> ${u.getGenre()}<br>
							<strong>Songs:</strong> ${u.getSongCount()}<br>
							<strong>Date:</strong> ${u.getRegdate()}<br>
						</p>
